...
{
    public class TankCombiner
    {
        private IFolderCombiner _folderCombiner;

        public TankCombiner(IFolderCombiner folderCombiner)
        {
        ...
        public void GenerateCharacter(string characterFolder, string outputFolder)
        {
            ...
            //standard
            _folderCombiner.CombineFolder("Input\\Tank", "Input\\" + characterFolder + "\\Torso", outputFolder + "\\StandardBehaviour");
