...
{
    public class NinjaGenerator
    {
        private IFolderCombiner _folderCombiner;

        public NinjaGenerator(IFolderCombiner folderCombiner)
        {
        ...
        public void GenerateCharacter(string characterFolder, string outputFolder)
        {
            ...
            //jump
            _folderCombiner.CombineFolder("Input\\Jump", "Input\\" + characterFolder + "\\Torso", outputFolder + "\\Jump");
            _folderCombiner.CombineFolder("Input\\Jump", "Input\\" + characterFolder + "\\TorsoH", outputFolder + "\\JumpH");
            _folderCombiner.CombineFolder("Input\\Jump", "Input\\" + characterFolder + "\\TorsoT", outputFolder + "\\JumpT");
            _folderCombiner.CombineFolder("Input\\Jump", "Input\\" + characterFolder + "\\TorsoA", outputFolder + "\\JumpA");

            _folderCombiner.CombineFolder("Input\\LegsDestroyed", "Input\\" + characterFolder + "\\Torso", outputFolder + "\\JumpLe");
