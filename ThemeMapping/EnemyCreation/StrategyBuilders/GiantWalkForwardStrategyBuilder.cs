...
{
    public class GiantWalkForwardStrategyBuilder : IStrategyBuilder
    {
        ...
        public GiantWalkForwardStrategyBuilder(ISoundSharer soundSharer, IWeaponFirererBuilder weaponFirererBuilder, IEnemyProviderCreator enemyProviderCreator, IQuakeTriggerer quakeTriggerer)
        {
        ...
        IBehaviourStrategy IStrategyBuilder.CreateStrategy(ElementTheme characterTheme, IWorldElementProvider playerProvider, IWorldElementProvider simpleSoldierProvider, IListProvider<IWorldElement> visibleListProvider, IElementCreator elementCreator, IDucker ducker, IDestructibleBodyProvider destructibleBodyProvider)
         {
            ...
            IBehaviourStrategy guardianStrategy = new CircleWalkStrategy(footSwitcher, new CounterClockwiseRotater(), 0.55, 10, stepFreeSpaceTester, 75);
            ...
            IBehaviourStrategy attackFollowStrategy = new SimpleFollowStrategy(new PositionProvider(cachingProvider), new UpdateTimer(2.0), footSwitcher, 0.7, 0.5, targetDegreeCalculator, 85);
            ...
            IBehaviourStrategy quakeDecorator = new StepQuakeStrategy(priorizedStrategy, _quakeTriggerer, 0.5);
