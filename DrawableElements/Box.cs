...
{
    public class Box : IDrawable, IVisualParameterUpdater, IVisualParameterized
    {
        ...
        public Box(IVisualParameters visualParameters, Degree rotation, IPolygonRenderer polygonRenderer)
        {
            VisualParameters = visualParameters;
            _polygonRenderer = polygonRenderer;
            CreatePolygons(visualParameters, rotation);
        }
        ...
        private void CreatePolygons(IVisualParameters visualAppearance, Degree rotation)
        {
