...
{
    public class HelicopterBackwardStrategyBuilder : IStrategyBuilder
    {
        ...
        public HelicopterBackwardStrategyBuilder(ISoundSharer soundSharer, IWeaponFirererBuilder weaponFirererBuilder, IEnemyProviderCreator enemyProviderCreator,
        ...
        IBehaviourStrategy IStrategyBuilder.CreateStrategy(ElementTheme characterTheme, IWorldElementProvider playerProvider, IWorldElementProvider simpleSoldierProvider, IListProvider<IWorldElement> visibleListProvider, IElementCreator elementCreator, IDucker ducker, IDestructibleBodyProvider destructibleBodyProvider)
         {
            ...
            IBehaviourStrategy guardianStrategy = new BackwardMovementStrategy(new CounterClockwiseRotater(),60);
            ...
            _helicopterCollapseStrategy.SetSpinningStrategy(new SpinningGravityStrategy(simpleSoldierProvider, 
                new SpinningAccelerator(4),new GravitationCalculator(0.01, 100), new Exploder(_explosionManager, 600, 4)));
