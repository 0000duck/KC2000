...
{
    public class MarkableLoopedAnimationSprite : IDrawable, ICommunicationElement, IVisualParameterized
    {
        ...
        public MarkableLoopedAnimationSprite(IAnimation animation, ITextureChanger textureChanger, Position3D position, IDrawable sprite, IDrawable markedSprite, IDegreeCalculator degreeCalculator, double animationDuration, IWorldTranslator worldTranslator)
        {
            Animation = animation;
