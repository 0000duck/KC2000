...
{
    public class RotateAndDuckAttackStrategy : IBehaviourStrategy
    {
        ...
        public RotateAndDuckAttackStrategy(IWorldElementProvider enemyProvider, IWeaponFirerer weaponFirerer, IDucker ducker, IRotater rotater, IRandomDurationGenerator randomDurationGenerator, ITargetDegreeCalculator targetDegreeCalculator)
        {
                ...
                case Status.Ducking:
                    ...
                    else
                    {
                        ...
                        if (enemy != null)
                        {
                            ...
                            _rotater.StartRotation(behaviourParameters.Orientation, targetDegree);
